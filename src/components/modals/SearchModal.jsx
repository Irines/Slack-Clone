                ...
                :
                    <div className='options'>
                        ...
                        <div className="row-items">
                            <div className="item"><ForumOutlinedIcon></ForumOutlinedIcon>Messages</div>
                            <div className="item"><FolderOpenIcon></FolderOpenIcon>Files</div>
                            <div className="item"><TagOutlinedIcon></TagOutlinedIcon>Channels</div>
                            <div className="item"><PeopleOutlineOutlinedIcon></PeopleOutlineOutlinedIcon>People</div>
                        </div>
                    </div>
            }
        </DialogContent>
